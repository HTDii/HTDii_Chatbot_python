...
SALE_INTRO = {
    "VI": "🛒 Chúng tôi cung cấp các giải pháp tiếp thị số giúp hỗ trợ tăng trưởng "
          "và tối ưu hiệu quả hoạt động trên các nền tảng mạng xã hội.",
    "EN": "🛒 We provide digital marketing solutions to support growth and "
          "optimize performance on social media platforms.",
    "JP": "🛒 当社は、SNSプラットフォーム上での成長支援および "
...
SALE_CATEGORY_REPLY = {
    "SNS_PERSONAL": {
        "VI": "Chúng tôi tập trung vào việc tối ưu nội dung, lịch đăng tải và "
              "các công cụ hỗ trợ tăng trưởng phù hợp với chính sách nền tảng.",
        "EN": "We focus on content optimization, posting schedules and "
              "platform-compliant growth support tools.",
        "JP": "コンテンツ最適化、投稿スケジュール、および "
              "プラットフォーム規約に準拠した成長支援を行います。"
    },
    "BRAND_BUILDING": {
        "VI": "Dịch vụ xây dựng thương hiệu cá nhân giúp định vị hình ảnh, "
              "thông điệp và phong cách nội dung một cách bền vững.",
        "EN": "Personal brand building services help define positioning, "
              "messaging and content style sustainably.",
        "JP": "個人ブランド構築サービスでは、イメージやメッセージ、 "
              "コンテンツスタイルを長期的に最適化します。"
    },
    "KOL_SUPPORT": {
        "VI": "Hỗ trợ Creator/KOL phát triển kênh thông qua phân tích dữ liệu "
              "và chiến lược nội dung dài hạn.",
        "EN": "We support creators and KOLs through data analysis "
              "and long-term content strategies.",
        "JP": "データ分析および長期的なコンテンツ戦略を通じて "
              "KOL・クリエイターを支援します。"
    },
    "GENERAL_GOAL": {
        "VI": "Hãy chia sẻ mục tiêu của bạn, chúng tôi sẽ đề xuất "
              "hướng triển khai phù hợp.",
        "EN": "Please share your goal and we will propose "
              "a suitable approach.",
        "JP": "目標を教えていただければ、最適な進め方をご提案します。"
    },
}
...
SALE_PLATFORM_REPLY = {
    "VI": "Chúng tôi tập trung vào tối ưu nội dung, phân tích hành vi người dùng "
          "và các công cụ hỗ trợ tăng trưởng minh bạch, tuân thủ điều khoản sử dụng.",
    "EN": "We focus on content optimization, audience behavior analysis "
          "and transparent growth support tools that comply with platform policies.",
    "JP": "コンテンツ最適化、ユーザー行動分析、および "
...
SALE_FALLBACK = {
    "VI": "Tôi đã ghi nhận yêu cầu của bạn. Bạn có thể chọn một mục tư vấn.",
    "EN": "I have noted your request. Please select a consultation option.",
    "JP": "ご要望を受け取りました。相談項目を選択してください。"
}